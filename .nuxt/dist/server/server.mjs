...
import { faPen, faUser, faEnvelope, faPaperPlane, faCakeCandles, faMobileScreenButton, faXmark } from "@fortawesome/free-solid-svg-icons";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index--kxnWO55.js")
  }
];
...
const icons = { freeFasFaPen: faPen, freeFasFaUser: faUser, freeFasFaEnvelope: faEnvelope, freeFasFaPaperPlane: faPaperPlane, freeFasFaCakeCandles: faCakeCandles, freeFasFaMobileScreenButton: faMobileScreenButton, freeFasFaXmark: faXmark };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-x0Q0sfFa.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-E0j9TAF5.js"));
