...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderTeleport } from 'vue/server-renderer';
import { useSSRContext, ref, computed, mergeProps, unref, defineComponent, reactive, watch } from 'vue';
...
const _imports_0 = "" + buildAssetsURL("profile.Cx8V1ArL.svg");
const _sfc_main$5 = {
  __name: "Profile",
  __ssrInlineRender: true,
  setup(__props) {
...
const works = [
  ...
  },
  {
    year: "2024",
    title: "\uC774\uD22C\uC2A4 \uAD50\uC721",
    desc: "\uAD6D\uB0B4 \uC628\xB7\uC624\uD504\uB77C\uC778 \uC785\uC2DC \uAD50\uC721 \uD559\uC6D0<br />\uC6F9 \uBC0F \uBAA8\uBC14\uC77C \uC0AC\uC774\uD2B8 \uC678\uC8FC<br /> \uC6B4\uC601 \uBC0F \uC774\uBCA4\uD2B8 \uD398\uC774\uC9C0 \uAD6C\uD604",
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul><div class="text_area motion" data-v-9a9d3b87><div class="text" data-v-9a9d3b87><h3 data-v-9a9d3b87>${ssrInterpolate(skill.value.title)}</h3><p data-v-9a9d3b87>${(_a = skill.value.desc) != null ? _a : ""}</p></div></div></section>`);
    };
  }
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (isShow.value) {
          ...
          _push2(`<button type="button" class="prev" data-v-8ceae292>PREV</button><button type="button" class="next" data-v-8ceae292>NEXT</button></div><p class="works_title" data-v-8ceae292>${ssrInterpolate(unref(item).title)}</p><p class="works_desc" data-v-8ceae292>${(_a = unref(item).desc) != null ? _a : ""}</p><p class="works_tags" data-v-8ceae292><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data).works, (item, i) => {
        var _a, _b;
        _push(`<li data-v-7aa4b64b><div class="text_wrap" data-v-7aa4b64b><p class="year" data-v-7aa4b64b>${ssrInterpolate(item.year)}</p><p class="title" data-v-7aa4b64b>${(_a = item.title) != null ? _a : ""}</p><p class="desc" data-v-7aa4b64b>${(_b = item.desc) != null ? _b : ""}</p><!--[-->`);
...
//# sourceMappingURL=index--kxnWO55.mjs.map
